...
\subsection{History} % A subsection can be created just before a set of slides with a common theme to further break down your presentation into chunks
...
\newblock Linux System and Applicaton Observalility
\end{thebibliography}
}
\end{frame}
